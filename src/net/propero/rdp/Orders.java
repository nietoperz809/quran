...
public class Orders
{
    static Logger logger = Logger.getLogger("Orders");
        ...
        while (processed < n_orders)
        {
            ...
            else
            {
                ...
                switch (os.getOrderType())
                {
                    ...
                    case RDP_ORDER_TEXT2:
                        logger.info("Text2 Order");
                        this.processText2(data, os.getText2(), present, delta);
                        break;

                    default:
                        logger.info("Unimplemented Order type " + order_type);
                        return;
                }
            ...
            throws OrderException, RdesktopException
    {
        ...
        switch (type)
        {
            ...
            case RDP_ORDER_RAW_BMPCACHE:
                logger.info("Raw BitmapCache Order");
                this.processRawBitmapCache(data);
                break;

            case RDP_ORDER_COLCACHE:
                logger.info("Colorcache Order");
                this.processColorCache(data);
                break;

            case RDP_ORDER_BMPCACHE:
                logger.info("Bitmapcache Order");
                this.processBitmapCache(data);
                break;

            case RDP_ORDER_FONTCACHE:
                logger.info("Fontcache Order");
            ...
            default:
                logger.info("Unimplemented 2ry Order type " + type);
        }
            ...
            throws RdesktopException
    {
        ...
        if (Bpp == 1)
        {
            ...
            {
                logger.info("Failed to decompress bitmap");
            }
        }
        else
        {
            ...
            boolean compressed) throws RdesktopException, IOException
    {
        ...
        if (compressed)
        {
            ...
            if (bmpdataInt == null)
            {
                logger.info("Failed to decompress bitmap data");
                // xfree(bmpdata);
                return;
            }
        ...
        {
            logger.info("process_bmpcache2: ui_create_bitmap failed");
        }
            ...
            int present, boolean delta)
    {
        ...
        {
            logger.info("bad ROP2 0x" + line.getOpcode());
            return;
        }
            ...
            int present, boolean delta) throws RdesktopException
    {
        ...
        if ((present & 0x010000) != 0)
        {
            ...
            logger.info("Unknown order state member (0x010000) in text2 order.\n");
        }
    ...
    private void drawText(Text2Order text2, int clipcx, int clipcy, int boxcx, int boxcy) throws RdesktopException
    {
        ...
        /*
         * logger.info("X: " + text2.getX() + " Y: " + text2.getY() + " Left Clip: " +
