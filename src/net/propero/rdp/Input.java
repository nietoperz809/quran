...
public abstract class Input
{
     ...
     * Actions are represented as a pair of consecutive characters, the first
     * character's value (cast to integer) being the scancode to send, the
     * second (cast to integer) of the pair representing the action (0 == UP, 1
     * == DOWN, 2 == QUIET UP, 3 == QUIET DOWN).
     */
    ...
    class RdesktopMouseAdapter extends MouseAdapter
    {
        ...
        public void mousePressed(MouseEvent e)
        {
            if (e.getY() != 0)
            {
                // *error* ((RdesktopFrame_Localised) canvas.getParent()).hideMenu();
            }
    ...
    class RdesktopMouseMotionAdapter extends MouseMotionAdapter
    {
        ...
        public void mouseMoved(MouseEvent e)
        {
            ...
            if (e.getY() == 0)
            {
                // *error* ((RdesktopFrame_Localised) canvas.getParent()).showMenu();
            }
