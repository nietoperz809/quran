...
public class CMULexicon extends LexiconImpl {
	...
	public CMULexicon(String basename, boolean useBinaryIO) {
		...
		URL letterToSoundURL = classLoader.getResource( basename + "_lts." + type);
		URL compiledURL = classLoader.getResource( basename + "_compiled." + type);
		URL addendaURL = classLoader.getResource( basename + "_addenda." + type);

		System.out.println(letterToSoundURL);
