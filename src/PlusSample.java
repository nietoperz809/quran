...
public class PlusSample
{
    ...
    {
        InputStream ps = PlusSample.class.getResourceAsStream("/client_secrets.json");
        if (ps == null)
        {
            System.out.println("ps fuck!");
            System.exit(0);
        }
        InputStreamReader is = new InputStreamReader(ps);
        if (is == null)
        {
            System.out.println("is fuck!");
            System.exit(0);
        }
        // load client secrets
